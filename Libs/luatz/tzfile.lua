...
local tz_info_mt = addon.luatz.tzinfo.tz_info_mt
local tt_info_mt = addon.luatz.tzinfo.tt_info_mt
...
local function read_tzfile(path)
	local fd = assert(addon.luatz.NewMockFileDescriptor(addon.luatz.zoneinfo[path]))
